  ...
  return (
    <div>
      ...
      <div className='max-w-[713px] mx-0 md:mx-auto my-0 md:my-[148px] px-[20px] md:px-0 py-10 md:py-0'>
        <h1 className='platypi-gf font-[600] text-[#23323F] text-[34px] md:text-[60px] md:text-center leading-[40px] md:leading-[64px] tracking-[-0.5%] md:tracking-[-1%] mb-[32px]'>
          Our Journey So Far
        </h1>
      ...
      <div className=' py-[83px] px-[16px] md:px-0'>
        <div className='flex justify-center flex-col md:flex-row items-center gap-[28px]'>
          {cardValues.map((cardValue) => (
            <div
              className='w-full md:w-[200px] rounded-[16px] p-[24px]'
              key={cardValue.id}
              style={{ background: cardValue.bg }}
            >
              <h2 className='font-regular text-[14px] text-[#000] leading-[20px] mb-[8px]'>
                {cardValue.title}
              </h2>
