      ...
      <div className='relative w-[90%] max-w-md rounded-2xl bg-white p-8 shadow-xl'>
        ...
        <div className='flex flex-col items-center text-center'>
          <div className='relative mb-6'>
            <div className='absolute inset-0 rounded-full bg-red-100 opacity-50 scale-125' />
            <div className='relative flex h-16 w-16 items-center justify-center rounded-full bg-[#FEE2E2]'>
          ...
          <button
            onClick={onClose}
            className='mt-8 w-full rounded-lg bg-[#0F172A] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#1e293b]'
          >
            Try Again
          </button>
        </div>
